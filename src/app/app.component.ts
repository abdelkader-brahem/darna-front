...
export class AppComponent {
  ...
  user;
  isLoggedIn: Boolean;
  constructor(private toastr: ToastrService,private loginService: LoginService,private notifyService : NotificationService) { this.socket = socketIO('http://127.0.0.1:8080') ;}
   ngOnInit(): void {
    this.sound = new Howl({
